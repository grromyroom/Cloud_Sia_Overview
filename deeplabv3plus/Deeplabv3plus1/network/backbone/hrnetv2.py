...
class StageModule(nn.Module):
    def __init__(self, stage, output_branches, c):
        ...
        for i in range(self.number_of_branches):  # Stage scales with the number of branches. Ex: Stage 2 -> 2 branch
            ...
            self.branches.append(branch)  # list containing all forward sequence of individual 1es.

        # For each 10 requires repeated fusion with all other branches after passing through x4 basic blocks.
